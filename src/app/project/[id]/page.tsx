      ...
      <header className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 shadow-xl">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <div className="flex items-center justify-between mb-3">
            <Link href="/dashboard" className="flex items-center space-x-2 text-white hover:opacity-80 transition-opacity">
          ...
          <details className="group">
            ...
            <div className="mt-2 bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <p className="text-white/90 text-sm leading-relaxed">{project.goal}</p>
            </div>
          </details>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm border-t border-white/20">
          <div className="max-w-7xl mx-auto px-6 py-3">
            <div className="grid grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div className="text-xl font-bold text-green-300">{stats.done}</div>
                <div className="text-white/70 text-xs font-medium">Done</div>
              </div>
              <div>
                <div className="text-xl font-bold text-blue-300">{stats.inProgress}</div>
                <div className="text-white/70 text-xs font-medium">In Progress</div>
              </div>
              <div>
                <div className="text-xl font-bold text-red-300">{stats.blocked}</div>
                <div className="text-white/70 text-xs font-medium">Blocked</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <AgentActivity events={project.events} />
          </div>
        </div>
      </div>
    </div>
